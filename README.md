...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/pioneer-base)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/pioneer-base
```

A live public deployment of this template is available at [https://pioneer-base.templates.workers.dev](https://pioneer-base.templates.workers.dev)
